      ...
      <div class="row no-gutters">
        <div class="offset-md-1 col-md-8">
          <div class="container">
            ...
            <hr> 
            <div class="text-left">
              <a class="twitter-share-button pt-1" href="https://twitter.com/intent/tweet?text=<?php urlencode(the_title()) ?>" data-size="large">Tweet</a>
            ...
            <div class="card text-center">
              <div class="card-header">
                <div class="title-entradas text-center pt-2 pb-2">
                  <span class="text-entrada">Artículos Relacionados</span>
                </div>
              </div>
              <div class="card-body text-center">
                <section class="post-relacionados mt-3 ml-5">

                  <div class="row" id="for-view">
                    <?php 
